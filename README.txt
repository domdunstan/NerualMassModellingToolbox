This repository allows for the implementation of methods 
used in Dunstan et al. (2023) 'Global nonlinear approach for mapping parameters of neural mass models'.
