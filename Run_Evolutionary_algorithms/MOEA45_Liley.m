function MOEA45_Liley(M,run_number,population_size)

% Script runs the Multiobjecitve evolutionary algorithm MOEA45. See paper
% for details.
...
dd3 = dd3-z2;
dd3 = dd3/sum(dd3);
eegdattot = {dd3,z,z2,d};
% set up fitness function
ff = @(x) fitness_moea45(x, paramsvec, eegdattot, paramstoest,T1, tcut, fhz1);
...
save(['MOEA45_subject_' num2str(M) '_' num2str(run_number) '.mat'],'out');
