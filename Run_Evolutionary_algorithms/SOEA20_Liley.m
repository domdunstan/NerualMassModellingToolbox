function SOEA20_Liley(M,run_number,population_size)

% Script runs the sinlgeobjecitve evolutionary algorithm SOEA20. See paper
% for details.
...
eegdattot = {data, dd, tcut,lags_data};
% set up fitness function
ff = @(x) fitness_soea20(x, paramsvec, eegdattot, paramstoest,T1, tcut, fhz1);
...
save(['SOEA20_subject_' num2str(M) '_' num2str(run_number) '.mat'],'out');
