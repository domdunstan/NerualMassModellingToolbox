function [y,t2] = ode45_Liley(t, params)
% simulate deterministic version of the Liley model using ODE45
...
f=@(t,y) ([te*(he_rest-y(1)+y(3).*((he_eq-y(1))./abs1)+y(7).*((hi_eq-y(1))./abs2));...
