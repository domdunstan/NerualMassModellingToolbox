function rgb = vals2colormap(vals, colormap, crange)
    ...
    %% This function has been adopted and edited from a Github repository. The original function is freely avalibale at the following: "https://github.com/vistalab/vistateach".
